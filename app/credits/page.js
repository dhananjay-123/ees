    ...
    <div className="min-h-screen bg-[#F1F5F9] transition-colors duration-500">
      <div className="max-w-6xl mx-auto py-12 md:py-24 px-6 md:px-10 text-center">
        ...
        <section className="mb-24 md:mb-32">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-12 md:mb-16 tracking-tighter text-[#0F172A]">The AeroGradient Stack</h1>
        ...
        <footer className="mt-20 opacity-40">
          <p className="text-[9px] font-black uppercase tracking-[0.5em] text-[#64748B]">AeroGradient &copy; 2026</p>
        </footer>
      </div>
    </div>
  );
